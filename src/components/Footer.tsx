          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 flex items-center justify-center rounded-full bg-lavender-800 text-lavender-200 hover:bg-lavender-700 hover:text-white transition-colors duration-200"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
